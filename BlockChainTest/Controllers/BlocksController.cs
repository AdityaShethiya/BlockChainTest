...
namespace BlockChainTest.Controllers
{
    public class BlocksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BlockId,timpStamp,previousHash,hash,Nonce")] Block block)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BlockId,timpStamp,previousHash,hash,Nonce")] Block block)
        {
            if (ModelState.IsValid)
            {
